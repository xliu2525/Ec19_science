...
def generate_mpnn_designs_parallel(context, gene_name, uniprot_id, reference_seq, letter_to_redesign,
    ...
    try:
        ...
        designs = generate_mpnn_designs(context.data_root, context.code_root, gene_name, uniprot_id, reference_seq, letter_to_redesign,
            include_neighbors, temp, mpnn_designs_num, spatial_neighbors, confind_neighbors, confind_dir, confind_cutoff, config_version)
        return designs
    except Exception as e:
        import traceback
...
def score_designs_parallel(context, gene_name, uniprot_id, reference_seq, letter_to_redesign, spatial_neighbors,  confind_neighbors, confind_dir, confind_cutoff, mpnn_designs_num,
    ...
    try:
        ...
        print(f"Scoring designs for {uniprot_id} with args: gene_name={gene_name}, letter_to_redesign={letter_to_redesign}, spatial_neighbors={spatial_neighbors},confind_neighbors={confind_neighbors}, mpnn_designs_num={mpnn_designs_num}, multimer={multimer}, single_chain={single_chain}, config_version={config_version}, llm_designs={llm_designs}, method={method}")
        results = score_designs(context.data_root, context.code_root, gene_name, uniprot_id, reference_seq, letter_to_redesign, spatial_neighbors,  confind_neighbors, confind_dir, confind_cutoff,
